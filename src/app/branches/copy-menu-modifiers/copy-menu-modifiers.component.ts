...
@Component({
  selector: 'app-copy-menu-modifiers',
  templateUrl: './copy-menu-modifiers.component.html',
  styleUrls: ['./copy-menu-modifiers.component.scss']
})
export class CopyMenuModifiersComponent {
