...
export class HttpServiceService {
  ...
  private requestOptions() {
    let httpHeader = {
      headers: new HttpHeaders({ 'Content-Type': 'application/json','Accept': 'application/json', 'Authorization': 'Bearer '+this.localService.get('token'),'CountryID' : this.countrySelected ? this.countrySelected.toString() : '' })
    };
    return httpHeader;
  }
